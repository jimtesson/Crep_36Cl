function [ethflux,thflux] = NeutronsLowE(h,Rct,s,w)
...
% for a = 1:length(Rc)
    ...
    ethflux = (trapz(E(clipindexethmmin:clipindexethmax),PhiGMev(:,clipindexethmmin:clipindexethmax),2))';
    clipindexth = find(E <= 5e-7, 1, 'last' ); %Find thermal neutron E
    thflux = (trapz(E(1:clipindexth),PhiGMev(:,1:clipindexth),2))';
